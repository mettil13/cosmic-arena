...
public class GoogleSheetDownload : MonoBehaviour
{
    // Variabili da valorizzare per far funzionare il tutto.
    // spreadSheetId: l'id del google sheet, cercate su internet su come trovarlo
    // tabId: l'id del tab del google sheet in oggeto
    //public string spreadSheetId, tabId;

    // Funzione da chiamare per importare il google sheet
    //public void ImportGoogleSheet(string spreadSheetId, string tabId)
    //{
        //StartCoroutine(DownloadCSVCoroutine(spreadSheetId, true, "YOUR_ASSET_NAME_NO_EXT", tabId));
    //}
    ...
    public static void DownloadCSVCoroutine(WWW download, bool saveAsset = false, string assetName = null)
    {
